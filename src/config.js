...
let deployedAddress;
try {
    deployedAddress = require(path.join(__dirname, '..', 'deployedAddress.json')).contractAddress;
} catch (error) {
    console.warn('Failed to read deployedAddress.json. Please check that the contract is deployed.');
}
